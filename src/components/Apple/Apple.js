        ...
        <div>
           <Tree fall ={fallApples}/>
            ...
            <div className="containerApple">
                    ...
                    <img src="images/apple.png" alt="" className={`appleImg3 ${fallApple1 ? 'fallAppl1' : null }`} />
                    <img src="images/apple.png" alt="" className={`appleImg4 ${fallApple2 ? 'fallAppl2' : null }`} />
                    <img src="images/apple.png" alt="" className={`appleImg5 `} />
                    <img src="images/apple.png" alt="" className={`appleImg6 `} />
                    <img src="images/apple.png" alt="" className={`appleImg7 ${fallApple3 ? 'fallAppl3' : null }`} />
            </div>
